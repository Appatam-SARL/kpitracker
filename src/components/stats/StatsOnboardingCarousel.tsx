...
const SLIDES: Slide[] = [
  {
    id: 'repartition',
    badge: 'Répartition',
    title: 'Analysez vos prospects',
    description:
      'Visualisez la répartition par type, source et rôle décideur pour mieux cibler vos actions.',
    cta: 'Voir la répartition',
    ctaHref: '#stats-repartition',
    tone: {
  ...
  },
  {
    ...
    description:
      'Générez un résumé sur une période : leads, clients convertis, CA — puis exportez en Excel.',
    cta: 'Résumé des ventes',
    ctaHref: '#stats-ventes',
    tone: {
      panel: 'bg-sky-600',
      badge: 'bg-sky-900/30',
      badgeText: 'text-white',
  ...
  },
  {
    id: 'objectifs',
    badge: 'Objectifs',
    title: 'Suivez les objectifs',
    description:
      'Comparez réalisations et cibles par commercial pour piloter l’atteinte des objectifs.',
    cta: 'Voir les objectifs',
    ctaHref: '#stats-objectifs',
    tone: {
      panel: 'bg-slate-800',
      badge: 'bg-white/15',
      badgeText: 'text-white',
...
export default function StatsOnboardingCarousel() {

...
const SLIDES: Slide[] = [
  {
    id: 'project',
    badge: 'KpiTracker',
    title: 'Tout votre commercial, un seul CRM',
    description:
      'KpiTracker centralise prospects, clients, agenda et catalogue pour que chaque commerciale avance avec la même vision.',
  ...
  },
  {
    id: 'advantage',
    badge: 'Avantage',
    title: 'Convertissez plus, plus vite',
    description:
      'Suivez chaque opportunité dans le pipeline, mesurez le taux de conversion et transformez vos leads en clients gagnés.',
  ...
  },
  {
    id: 'pilotage',
    badge: 'Pilotage',
    title: 'Pilotez avec des indicateurs clairs',
    description:
      'Objectifs, statistiques, rapports et agenda : décidez à partir de données actualisées, pas d’impressions.',
    cta: 'Ouvrir les statistiques',
    ctaHref: '/stats',
    tone: {
      panel: 'bg-slate-800',
      badge: 'bg-white/15',
...
export default function DashboardOnboardingCarousel() {
      ...
      <AnimatePresence initial={false} custom={direction} mode='popLayout'>
        ...
        >
          ...
          <div className='pointer-events-none absolute inset-y-0 right-0 hidden w-[42%] sm:block'>
            ...
            {slide.id === 'pilotage' && (
              <Target className='absolute right-28 top-8 h-7 w-7 text-white/50' />
            )}
          </div>

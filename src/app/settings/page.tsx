...
const FAQ_ITEMS = [
  {
    ...
    a: "Dans Gestion Prospects, utilisez Import pour charger le modèle Excel. Les colonnes d’adresse et de situation géographique (lien Maps) sont prises en charge.",
  },
  {
...
function SettingsPageInner() {
  ...
  const planLabel = PLAN_LABELS[org?.companyPlan ?? ""] ?? org?.companyPlan ?? "—";
  const kindLabel =
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-1 max-w-xl text-sm text-gray-500">
              Consultez l’organisation, votre compte et les accès utiles pour
              piloter KpiTracker.
            </p>
          </div>
